...
class Ockam < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      ...
      sha256 "b5ffe7fffbf2b0731a23370bb9378d2902a90e4f9cefacb20b2ebab0f694075a"
    ...
    if Hardware::CPU.intel?
      ...
      sha256 "bf9ad83f614285344618536e30cc79fdf68740a570232f473442877dbf831c06"
  ...
  on_linux do
    if Hardware::CPU.arm?
      ...
      sha256 "215bcab0923c81ebe1eb09ee55af02f00d4bf4f7437c160581fd2714ef6b8f6c"
    ...
    if Hardware::CPU.intel?
      ...
      sha256 "449ac0d9bc2456d02379dfdb351fc179a7501bfffb615d22aa83e0665c1f4906"
